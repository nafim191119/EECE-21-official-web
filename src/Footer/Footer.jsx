    ...
    return (
        <div>
            ...
            <footer className="footer footer-center p-10 bg-white text-black">
                <aside>
                    <img height={10} width={120} src="/src/assets/Military_Institute_of_Science_and_Technology_Monogram.svg.png" alt="" />
                    <p className="font-bold text-2xl">
                        MILITARY INSTITUTE OF SCIENCE AND TECHNOLOGY <br />Providing reliable tech since 1998-{currentYear}.
                    </p>
                    <p className="font-bold mt-2">Copyright © {currentYear} - All right reserved by <span className="bg-red-900 px-2 rounded-lg uppercase text-white">Nafim.</span></p>
                </aside>
