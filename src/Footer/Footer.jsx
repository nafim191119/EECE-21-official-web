        ...
        <div>
            <footer className="footer footer-center p-10 bg-white text-black">
                <aside>
                    ...
                    <p className="font-bold mt-2">Copyright © {currentYear} - All right reserved by <span className="bg-red-900 px-2 py-2 rounded-lg uppercase text-white">Nafim</span>.</p>
                </aside>
                <nav>
