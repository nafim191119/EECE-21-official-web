    ...
    return (
        <div>
            ...
            <div className="my-4 flex justify-center items-center gap-10">
                <div>
                    <div className="radial-progress bg-primary text-primary-content font-bold text-xl" style={{ "--value": "37.5", "--size": "16rem", "--thickness": "0.8rem" }} role="progressbar">37.5% Completed</div>
                </div>
            </div>
        </div>
    );
